                ...
                <div className='w-full h-full flex flex-col justify-center items-center'>
                    <div className='flex flex-col justify-center items-center gap-4'>
                        <h2 className='font-normal text-center text-lg tracking-[6px] text-neutral-400'>
                            Did you like my work? Let's make something awesome together!
                        </h2>
                        <a href='mailto:dennys9415@gmail.com'>
                            <div className='pre flex items-center gap-2 lg:gap-5 relative cursor-pointer'>
                                <h2 className='text-center text-5xl font-bold lg:text-[7vw] whitespace-nowrap leading-none w-[100%] text-neutral-900'>CONTACT ME</h2>
