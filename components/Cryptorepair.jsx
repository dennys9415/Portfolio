...
import Cryptorepair2 from '../public/assets/cryptorepair2.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-0">
          <div className="flex flex-col gap-5 lg:gap-10">
            <div className="w-full lg:w-[70%]">
              <h2 className="font-black text-neutral-900 text-3xl md:text-5xl">Cryptorepair</h2>
            </div>
            ...
            <div className="w-full lg:w-[70%] flex flex-col gap-1">
                ...
                <div>
                    <h2 className='font-normal text-lg text-neutral-900'>
                        <a href='https://cryptorepair.com/' target="_blank" rel="noreferrer">Cryptorepair</a>
                    </h2>
                </div>
            </div>
